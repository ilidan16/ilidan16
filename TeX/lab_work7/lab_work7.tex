	...
	\begin{center}
		\begin{tikzpicture}[scale=0.9]
			\begin{axis}[xlabel={$l$, см}, ylabel={$\Delta P$, кПа}, ymajorgrids, minor tick num = 1]
				...
				\addplot [blue, line width=1pt, domain=24:36]{3797.97/x-110.02};
				
				%-------------------------------------------------------------------------------

				\addplot [black,line width=1.1pt, domain=24:36]{4121.88/x-119.521};
				%-------------------------------------------------------------------------------

				\addplot [red,line width=1.1pt, loosely dashed, domain=24:36]{4309.08/x-126.374};
			\end{axis}
		\end{tikzpicture}
	\end{center}
\end{figure}
...
\begin{enumerate}
	...
	\item $\large{\omega_1} \approx6,284\pm0,001\;\mbox{Гц}$
	\item $\large{\omega_2} \approx6,284\pm0,001\;\mbox{Гц}$
	\item $\large{\omega_3} \approx6,285\pm0,001\;\mbox{Гц}$
\end{enumerate}

{\parindent=0pt\textbf{Выводы и анализ результатов.}}\\
Мы провели несколько изотермических сжатий идеального газа для проверки закона Бойля-Мариотта. Экстраполяция полученных данных дала коэффициенты, которые по порядку величины совпадают с ожидаемыми.

Полученные изотермы оказались не очень <<параллельными>>, потому что в опыте есть несколько недостатков: масса газа оставалась не постоянной, так как установка пропускала воздух, что заставляло нас сжимать газ с большой скоростью, а это не является квазистатическим процессом.
