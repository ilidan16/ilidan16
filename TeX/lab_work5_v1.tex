...
\begin{tikzpicture}[scale=0.95]
	\begin{scope}
		...
		\begin{axis}[ legend pos = north west, minor tick num = 1, grid=major,ymin=0,xmin=15,xmax=28, ymax=12,xlabel=$r{,}\;\mbox{см}$, ylabel=$I{,}\;\mbox{кг}\cdot\mbox{м}^2\cdot10^{-2}$]
			\legend{Таблица 2}
...
Мы измерили момент инерции маятника Обербека двумя способами.
\end{document}
