...
\begin{document}
	\begin{figure}[!]
\centering{\includegraphics[scale=0.25]{a}}\\
...
\begin{center}
	\fbox{$g_1\approx 8,8\quad\left(\frac{\mbox{м}}{\mbox{с}^2}\right)$}
\end{center}
...
\begin{center}
\fbox{$ g_2\approx 6,6\quad\left(\frac{\mbox{м}}{\mbox{с}^2}\right) $}
\end{center}
\end{enumerate}
